function ReturnStruct = readEclipseW2CAD(filename,struct)
% 
% eclipseFileStruct = readEclipseW2CAD(filename);
% anotherEclipseFileStruct = readEclipseW2CAD(filename,eclipseFileStruct);
% 
